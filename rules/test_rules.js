...
async function start () {
  ...
  //     }]
  //   },
  //   event: { type: 'five-year-tenure2' }
  // }
  // engine.addRule(tenureRule2)
  /**
  ...
  engine
    .on('success', event => {
      console.log("success");
      // console.log(facts.accountId + ' DID ' + 'meet conditions for the ' + event.type.underline + ' rule.')
    })
    .on('failure', event => {
      console.log("failed");
      // console.log(facts.accountId + ' did ' + 'NOT' + ' meet conditions for the ' + event.type.underline + ' rule.')
    })
    ...
    const jefferson = {
        company: null,
        status: "terminated_no",
        nidNumber: "123213213123"
    };
  ...
  engine.addFact('account-information', (params, almanac) => {
    ...
    return almanac.factValue('accountId')
      .then(async accountId => {
        ...
        // await sleep(3000);
          console.log("in account information: " + accountId);
        // return ()accountClient.getAccountInformation(accountId)
        return ((accountId == "j") ? jefferson : washington);
      })
  }, { priority: 100 })
  ...
  engine.addFact('employee-tenure', (params, almanac) => {
    ...
    return almanac.factValue('account-information')
      .then(accountInformation => {
        console.log("in employee-tenure: " + JSON.stringify(accountInformation));
  ...
  // engine.addFact('employee-tenure2', (params, almanac) => {
  //   console.log("1 emp2");
  //   return almanac.factValue('account-information')
  //     .then(accountInformation => {
  //       console.log("in employee-tenure2");
  //       const created = new Date(accountInformation.createdAt)
  //       const now = new Date()
  //       switch (params.unit) {
  //         case 'years':
